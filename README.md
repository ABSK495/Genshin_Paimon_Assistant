...
这是一个正在开发的原神自动化项目。目前已适配1080p和2k分辨率，自己选择对应的文件下载，游戏必须在全屏运行才能生效。

高分辨率例如原生4K显示器也可以使用2K版本，派懵会自动调整分辨率，在游戏中切换2K分辨率窗口模式，并且按下alt+enter切换全屏即可使用。

11月28日派懵开始第2次测试，测试时间截止至12月4日，欢迎提交建议和bug。
