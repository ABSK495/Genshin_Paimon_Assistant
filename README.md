...
这是一个正在开发的原神自动化项目。目前仅支持win10系统，1920x1080分辨率，全屏运行适配。11月21日已发布初版测试包，测试时间截止至11月27日。
测试版可以直接前往仓库列表进行下载，有问题随时联系作者。
分流地址：https://wwsn.lanzoue.com/iP0W41fjv1pi 密码:shfy
企鹅群：210389345
